      ...
      <div className="py-8 lg:py-14">
        {lang === "es" ? (
          <p className="w-full max-w-md">
            ...
            <br />
            <br />
            Formada junto a su maestra Eva García y posteriormente en la Escuela
            Superior de Arte Ernesto de la Cárcova, desde 1989 ha diseñado
            escenografías para cine, teatro y televisión. Esta experiencia
            atraviesa su producción visual: cada obra se concibe como una escena
            latente, un ambiente suspendido donde materiales, texturas y colores
            configuran una dramaturgia sin actores.
            <br />
            <br />
            ...
            la construcción de superficies estratificadas. Sus obras —exhibidas
            y coleccionadas en Argentina, Brasil, Chile y en Italia, incluyendo
            su participación en la Florence Biennale 2025 y presentaciones en
            galerías de Roma— funcionan como archivos sensibles: rastros
            temporales que permanecen abiertos e invitan a la mirada a
            desplazarse entre capas y a activar una lectura personal.
            <br />
            <br />
            ...
            luz, conservando siempre un margen de indeterminación que permite al

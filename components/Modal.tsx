...
const Modal = ({
  ...
  return (
    <>
      ...
      <button
        onClick={nextSlide}
        className="fixed left-20 lg:left-auto lg:right-8 top-12 lg:top-1/2 z-50 cursor-pointer hover:scale-105 transition-all"
      >
      ...
      <button
        onClick={prevSlide}
        className="fixed left-8 top-12 lg:bottom-auto lg:top-1/2 z-50 cursor-pointer hover:scale-105 transition-all"
      >
